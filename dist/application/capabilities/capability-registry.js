...
const DEFINITIONS = [
    ...
    descriptor("agent.select", "bounded_mutation", ["cli", "tui"], ["agent_active", "agent_registry_revision_current"], ["agents", "project"]),
    descriptor("agent.replace", "human_confirmation", ["cli", "tui"], ["agent_active", "agent_registry_revision_current"], ["agents", "project"]),
    descriptor("agent.deactivate", "human_confirmation", ["cli", "tui"], ["agent_registry_revision_current", "linked_session_confirmation"], ["agents", "project"]),
    descriptor("doctor.inspect", "read", ["cli", "tui", "web"], [], []),
    descriptor("doctor.repair_preview", "read", ["cli", "tui"], ["doctor_findings_exist"], []),
    descriptor("doctor.repair_apply", "human_confirmation", ["cli", "tui"], ["exact_repair_preview", "explicit_confirmation"], ["projects", "project", "feature", "agents"]),
