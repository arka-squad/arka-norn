...
function repositoryMermaid(run) {
    const labels = { source: "Code", tests: "Tests", manifest: "Dépendances", cicd: "CI/CD", observability: "Observabilité", product: "Produit et docs", web: "Interface web", iac: "Infrastructure", containers: "Conteneurs" };
