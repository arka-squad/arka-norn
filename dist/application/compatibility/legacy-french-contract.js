...
import { canonicalDocumentType, LEGACY_DOCUMENT_TYPES, LEGACY_ENUM_VALUES, LEGACY_FIELDS, } from "../../domain/compatibility/legacy-contract.js";
export * from "../../domain/compatibility/legacy-contract.js";
export function normalizeLegacyDocument(source, options = {}) {
...
function normalizeValue(value) {
    if (typeof value === "string")
        return LEGACY_ENUM_VALUES[value] ?? LEGACY_DOCUMENT_TYPES[value] ?? value;
...
//# sourceMappingURL=legacy-french-contract.js.map