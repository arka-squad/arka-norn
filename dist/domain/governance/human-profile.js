...
const EMAIL = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
export function createHumanProfile(value) {
    if (!PROFILE_ID.test(value.id))
        throw new Error("Human profile id is invalid.");
...
//# sourceMappingURL=human-profile.js.map