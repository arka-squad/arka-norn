 ...
 */
export async function fetchLatestNpmVersion(packageName: string, timeoutMs = 1_500): Promise<string | undefined> {
  if (!/^[a-z0-9._@/-]{1,214}$/u.test(packageName)) return undefined;
