...
import type {
  AgentTrackingView, FeatureTrackingView, GovernanceView, ProjectRelationshipGraph, RelationshipEdge, RelationshipNode,
} from "./contracts.js";

export function buildProjectRelationshipGraph(
  project: Project,
  features: readonly FeatureTrackingView[],
  governance: GovernanceView,
  agents: readonly AgentTrackingView[],
