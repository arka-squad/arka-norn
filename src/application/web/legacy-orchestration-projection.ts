...
import type { FsExecutionRegistryStore } from "../../adapters/outbound/filesystem/fs-orchestration-execution-registry-store.js";
import type { FsOrchestrationWorkerStateStore } from "../../adapters/outbound/filesystem/fs-orchestration-worker-state-store.js";
import type { FsOrchestrationCampaignStore } from "../../adapters/outbound/filesystem/fs-orchestration-campaign-store.js";
import type { OrchestrationTrackingView } from "./contracts.js";

type ExecutionRecord = Awaited<ReturnType<FsExecutionRegistryStore["load"]>>["executions"][number];
type WorkerState = Awaited<ReturnType<FsOrchestrationWorkerStateStore["load"]>>;
type CampaignRecord = Awaited<ReturnType<FsOrchestrationCampaignStore["load"]>>[number];
