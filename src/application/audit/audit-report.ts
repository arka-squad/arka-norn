...
function repositoryMermaid(run: AuditRun): string {
  const labels: Readonly<Record<string, string>> = { source: "Code", tests: "Tests", manifest: "Dependencies", cicd: "CI/CD", observability: "Observability", product: "Product and docs", web: "Web interface", iac: "Infrastructure", containers: "Containers" };
