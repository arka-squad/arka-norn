...
The canonical runtime types live in [`src/domain/framing/framing-plan.ts`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/src/domain/framing/framing-plan.ts). JSON Schema consumers use:
...
The model cannot write derived state, stabilization records, publication authority, or fingerprints. [`assertPlan`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/src/domain/framing/framing-plan.ts) recomputes and verifies those fields after every read and mutation.
...
The adapter in [`fs-repository-probe.ts`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/src/adapters/outbound/filesystem/fs-repository-probe.ts) counts files independently of bounded display samples and ignores build outputs, dependencies, Git metadata, Norn metadata, and GitNexus caches.
...
[`fs-framing-store.ts`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/src/adapters/outbound/filesystem/fs-framing-store.ts) stores mutable work outside the product repository:
...
They begin after framing. [`orchestration-v23-plan-builder.ts`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/src/composition/orchestration-v23-plan-builder.ts) accepts only an exact, signed, grounded Feature plan and maps its Lots to task plans. A missing, tampered, unpublished, or divergent plan blocks orchestration.
...
- [`tests/unit/framing-plan.test.ts`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/tests/unit/framing-plan.test.ts);
- [`tests/integration/framing-engine.test.ts`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/tests/integration/framing-engine.test.ts);
- [`tests/e2e/framing-cli.test.ts`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/tests/e2e/framing-cli.test.ts);
- [`web/src/views/framing-view.test.tsx`](https://github.com/arka-squad/arka-norn/blob/v2.3.5/web/src/views/framing-view.test.tsx).
