...
Version 2.3.2 introduces live framing before delivery. The same resumable plan can frame a Project into Feature candidates or a Feature into bounded Lots, then hand one exact published revision to the 2.3 delivery DAG.
